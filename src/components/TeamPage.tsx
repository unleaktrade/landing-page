...
const teamMembers: TeamMember[] = [
  {
    ...
    biography: "As CEO and CTO of UmbraTrade, Julien drives the strategic and technical vision behind a next-generation crypto trading platform that blends transparency, scalability, and intelligent automation. His leadership focuses on building a secure, high-performance ecosystem for digital asset trading, leveraging cutting-edge blockchain, AI, and token engineering principles. With deep expertise in decentralized finance, scalable architectures, and smart contract design, he oversees the full lifecycle of product innovation — from infrastructure and data systems to user experience and market strategy. His work ensures reliability, efficiency, and long-term value creation across all aspects of the platform. His pragmatic, innovation-driven approach continues to propel UmbraTrade's mission to redefine the future of crypto trading through engineering excellence and strategic vision.",
  ...
  },
  {
    ...
    biography: "With over 13 years leading international teams of 80+ IT experts, Guilhem brings exceptional expertise in IT architecture, digital transformation, CRM systems, cloud solutions, and cybersecurity to UmbraTrade. A passionate crypto-enthusiast deeply invested in blockchain innovation across SOL, SUI, EVM, and Aptos ecosystems, he combines technical mastery with strategic vision. As an application architect and technical project manager, he has driven international expansion and managed complex projects for both public and private clients. An expert in leadership, innovation, and team scaling, he combines strategic vision with a human-centered approach to ensure performance and regulatory compliance. Recognized for excellence in project management and RFPs, he fosters sustainable value creation through innovative technological solutions.",
